<template>
    <div class="newsletter">
            ...
            <v-row>
                ...
                <v-col>
                    <div class="subscribe  ">
                        <v-text-field placeholder="Enter your email here" elevation="0"
                            class="custom-text-field   "></v-text-field>
                        <v-btn class="btn text-none " color="rgba(83, 75, 66, 1)" height="55" variant="flat" rounded="0"
                            elevation="0" @click="subscribe">
                            Subscribe Now
                        </v-btn>
                    </div>
                </v-col>
